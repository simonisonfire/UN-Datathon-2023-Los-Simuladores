...
---
class: center, middle
```{r vehicle2, echo=FALSE, message=FALSE, warning=FALSE, dpi=200}
ggplot() + 
...
---
class: middle, center
```{r finally_tramways, echo=FALSE, message=FALSE, warning=FALSE, dpi=200}
